...
.fica-circle {
  ...
  padding:22px 20px;
  box-shadow:0 4px 20px rgba(168,200,232,0.5);
  flex-shrink:0;
}
...
.circle-label-dark  { font-size:11px; font-weight:bold; color:#1a3a6b; letter-spacing:1px; text-align:center; }
.circle-label-light { font-size:11px; font-weight:bold; color:white;   letter-spacing:1px; text-align:center; }
.pill-dark {
  background:white; border-radius:22px;
  padding:6px 16px;
  font-size:17px; font-weight:bold; color:#1a3a6b; text-align:center;
  white-space:nowrap;
}
.pill-light {
...
.circle-sub-dark  { font-size:9.5px; color:#2a5a80; text-align:center; }
.circle-sub-light { font-size:9.5px; color:rgba(255,255,255,0.8); text-align:center; }
...
.circle-below-label.inv { width:200px; }
/* Status badge */
.status-badge {
  margin:20px auto 0;
  padding:8px 24px;
...
/* Bottom section */
.bottom-section { text-align:center; margin-top:40px; }
.bottom-title { font-size:20px; font-weight:bold; color:#1a1a1a; letter-spacing:2px; }
.bottom-sub { font-size:13px; color:#2e6da4; font-style:italic; margin-top:6px; }
